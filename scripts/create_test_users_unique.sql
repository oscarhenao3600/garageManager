-- Script para crear usuarios de prueba con números de documento únicos
-- Ejecutar después de verificar que el sistema funciona

-- =====================================================
-- CREACIÓN DE USUARIOS DE PRUEBA COMPLETOS (NÚMEROS ÚNICOS)
-- =====================================================
...
('cliente1', 'cliente1@email.com', '$2b$10$WgwnG8nPyQ5nHjN4RdyOEujitmP/KODiiM8Z0QyLso91todBQ4/Ha', 'client', 'Ana', 'García', '77777778', '3007777777', true, false),
